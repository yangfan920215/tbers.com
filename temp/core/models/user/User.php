...
class User extends BaseModel implements CanResetPasswordContract /*implements UserInterface, RemindableInterface */{
...
//        'is_tester'                     => 'in:0, 1',
    ...
    public function generatePasswordStr($iPwdType = 1)
    {
        ...
        $oValidator = CustomValidator::make($this->toArray(), $aPwdRules);
