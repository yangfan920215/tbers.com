...
class nusoap_client extends nusoap_base  {
	...
	* @access   public
	*/
	function __construct($endpoint,$wsdl = false,$proxyhost = false,$proxyport = false,$proxyusername = false, $proxypassword = false, $timeout = 1, $response_timeout = 5, $portName = ''){
		parent::nusoap_base();
