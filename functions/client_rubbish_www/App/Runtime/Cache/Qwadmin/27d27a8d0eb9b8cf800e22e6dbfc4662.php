        ...
        <div class="ace-settings-box clearfix" id="ace-settings-box">
            ...
            <div class="pull-left width-50">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <!-- PAGE CONTENT BEGINS -->
                        <form class="form-horizontal" id="form" method="post" action="<?php echo U('update',array('id'=>$flash['id']));?>">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="title" id="title" placeholder="标题"
                                           class="col-xs-10 col-sm-5" value="<?php echo ($flash['title']); ?>">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="url" name="url" id="url" placeholder="链接地址" class="col-xs-10 col-sm-5"
                                           value="<?php echo ($flash['url']); ?>">
                                    <span class="help-inline col-xs-12 col-sm-7">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <div class="col-xs-10 col-sm-5"><?php echo UpImage("pic",400,100,$flash['pic']);?></div>
                                    <span class="help-inline col-xs-12 col-sm-7">
