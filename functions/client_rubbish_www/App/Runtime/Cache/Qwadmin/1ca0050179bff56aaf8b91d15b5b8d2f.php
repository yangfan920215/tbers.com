                    ...
                    <div class="col-xs-12">
                        ...
                        <form class="form-horizontal" id="form" method="post" action="<?php echo U('update');?>">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text"  readonly name="user" id="user" placeholder="渠道账户"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="dom" id="dom" placeholder="网站域名"
                                           class="col-xs-10 col-sm-5" value="<?php echo ($var["dom"]); ?>" readonly>
                                    <span class="help-inline col-xs-12 col-sm-7">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-9 col-sm-9">
                                    <div class="input-group col-xs-5">
                                        ...
                                        <input readonly class="form-control" id="dom_time" name="dom_time" value="<?php echo ($var["dom_time"]); ?>" type="text" data-date-format="dd-mm-yyyy" />
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input readonly type="text" name="_name" id="_name" placeholder="代理名称" class="col-xs-10 col-sm-5"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input readonly type="text" name="gold_group" id="gold_group" placeholder="代理奖金组" class="col-xs-10 col-sm-5"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="gold_show" id="gold_show" placeholder="显示金额" class="col-xs-10 col-sm-5" value="<?php echo ($var["gold_show"]); ?>">
                                    <span class="help-inline col-xs-12 col-sm-7">
												<span class="middle"></span>
											</span>
                                </div>
    ...
    $(function () {
        $(".btn-info.submit").click(function () {
           ...
           if (nickname.length > 30) {
            ...
            /*代理名称长度*/
            if (!checkNum(gold_show) || gold_show > 999999999.99 || gold_show < 0) {
                bootbox.dialog({
                    title: '友情提示：',
                    message: "显示金额必须填写,且最多輸入9位數, 2位小數。",
                    buttons: {
                        "success": {
                            "label": "确定",
                            "className": "btn-danger"
