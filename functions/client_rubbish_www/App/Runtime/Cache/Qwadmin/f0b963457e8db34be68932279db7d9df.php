                    ...
                    <div class="col-xs-12">
                        ...
                        <table class="table table-striped table-bordered" id="table">
                            ...
                            <tr>
                                ...
                                <th class="col-xs-1">网站域名</th>
                                <th class="col-xs-1">域名截止日期</th>
                                <th class="col-xs-1">代理名称</th>
                                <th class="col-xs-1">代理奖金组</th>
                                <th class="col-xs-1">备注信息</th>
...
<!--                                    <td class="center">
                                    ...
                                    <td><?php echo ($val['dom']); ?></td>
                                    <td><?php echo ($val['dom_time']); ?></td>
                                    <td><?php echo ($val['_name']); ?></td>
                                    <td><?php echo ($val['gold_group']); ?></td>
                                    <td><?php echo ($val['_description']); ?></td>
                                    <td><?php echo ($val['nickname']); ?></td>
                                    <td><?php echo ($val['gold_show']); ?></td>
                                    <td><?php echo ($val['_url1']); ?></td>
                                    <td><?php echo ($val['_url2']); ?></td>
                                    <td><?php echo ($val['qq_json']); ?></td>
                                    <td><?php echo ($val['dom_status']); ?></td>
                                    <td><a href="<?php echo U('edit',array('id'=>$val['id']));?>"><i
                                            class="ace-icon fa fa-pencil bigger-100"></i>修改</a>&nbsp&nbsp;<a
                                            href="javascript:;" val="<?php echo U('del',array('uids'=>$val['uid']));?>" class="dellink"><i
                                            class="ace-icon fa fa-trash-o bigger-100 red"></i>删除</a>&nbsp;<a href="<?php echo U('createStaticHtml',array('id'=>$val['id']));?>"><i
                                            class="ace-icon fa fa-pencil bigger-100"></i>生成站点</a></td>
