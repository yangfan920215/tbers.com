        ...
        <div class="ace-settings-box clearfix" id="ace-settings-box">
            ...
            <div class="pull-left width-50">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <!-- PAGE CONTENT BEGINS -->
                        <form class="form-horizontal" id="form" method="post" action="<?php echo U('refuse');?>">
                            <input name="id" type="hidden" value="<?php echo ($var["id"]); ?>">
                            <div class="form-group">
                                <label class="col-sm-1 control-label no-padding-right" for="form-field-1"> 拒绝理由 </label>
                                <div class="col-sm-9">
                                    <input type="text" name="msg" id="_msg" placeholder="拒绝理由"
                                           class="col-xs-10 col-sm-5" value="<?php echo ($var["_msg"]); ?>">
