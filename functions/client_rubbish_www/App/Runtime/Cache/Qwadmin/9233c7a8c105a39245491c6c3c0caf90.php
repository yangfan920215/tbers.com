            ...
            <div class="pull-left width-50">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <!-- PAGE CONTENT BEGINS -->
                        <div class="cf">
                            <a class="btn btn-info" href="<?php echo U('addAttr');?>" value="">新增</a>
                        </div>
                        ...
                        <table class="table table-striped table-bordered">
                            ...
                            <?php if(is_array($vars)): $i = 0; $__LIST__ = $vars;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
                                    ...
                                    <td><?php echo ($val['_val']); ?></td>
                                    <td><?php echo ($val['_describe']); ?></td>
                                    <td><a href="<?php echo U('editAttr',array('id'=>$val['id']));?>"><i
                                            class="ace-icon fa fa-pencil bigger-100"></i>修改</a></td>
