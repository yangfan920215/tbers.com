                    ...
                    <div class="col-xs-12">
                        ...
                        <form class="form-horizontal" id="form" method="post" action="<?php echo U('update');?>">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" maxlength="20"  <?php if($var['edit']): ?>readonly<?php else: ?>name="user" id="user" placeholder="渠道账户"<?php endif; ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <span class="help-inline col-xs-12 col-sm-7">
												<span class="middle">*<?php if($var['edit']): ?>：若不修改密码该行不需要输入<?php else: ?>：最少输入8个字符,最多输入20个字符<?php endif; ?></span>
											</span>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="control-label no-padding-left col-sm-1">
                                    <select id="dom_status" name="dom_status" class="multiselect">
                                        <option value="0"
                                        <?php if($var["dom_status"] == 0): ?>selected="selected"<?php endif; ?>
                                        >开启</option>
                                        <option value="1"
                                        <?php if($var["dom_status"] == 1): ?>selected="selected"<?php endif; ?>
                                        >关闭</option>
                                    </select>
                                </div>
                                <span class="help-inline col-xs-12 col-sm-7">
...
<script type="text/javascript">
    $(function () {
        $(".btn-info.submit").click(function () {
            ...
            // 新增模式下
            <?php if(!$var['edit']): ?>var user = $("#user").val();
