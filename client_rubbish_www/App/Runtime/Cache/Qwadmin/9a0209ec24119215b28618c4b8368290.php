        ...
        <div class="ace-settings-box clearfix" id="ace-settings-box">
            ...
            <div class="pull-left width-50">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <!-- PAGE CONTENT BEGINS -->
                        <form class="form-horizontal" id="form" method="post" action="<?php echo U('attrUpdate');?>">
                            <input name="id" type="hidden" value="<?php echo ($var["id"]); ?>">
                            <div class="form-group">
                                <label class="col-sm-1 control-label no-padding-right" for="form-field-1"> 变量说明 </label>
                                <div class="col-sm-9">
                                    <input type="text" name="_describe" id="_describe" placeholder="变量说明"
                                           class="col-xs-10 col-sm-5" value="<?php echo ($var["_describe"]); ?>">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" <?php if($var['edit']): ?>readonly<?php else: ?> name="_name" id="_name" placeholder="变量名称"<?php endif; ?> class="col-xs-10 col-sm-5"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="_val" id="_val" placeholder="变量值" class="col-xs-10 col-sm-5"
                                           value="<?php echo ($var["_val"]); ?>">
                                    <span class="help-inline col-xs-12 col-sm-7">
												<span class="middle"></span>
											</span>
                                </div>
