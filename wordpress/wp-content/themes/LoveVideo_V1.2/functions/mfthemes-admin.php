			...
			<div id="set-cont" class="clx">
				<ul>
					...
					<li>
						...
						<div class="item clx">
							<div class="span span1"><label class="set-label" for="mfthemes_options[phzoom]">phzoom灯箱</label></div>
							<div class="span span2 span2-notes"><input id="phzoom" type="checkbox" name="mfthemes_options[phzoom]" value="1" <?php if($options['phzoom']) echo 'checked="checked"'; ?>/><label for="phzoom">开启 phzoom灯箱 功能</label></div>
							<div class="span span3"><small class="set-small">选中后 内页图片会以灯箱形式展现</small></div>
						</div>
						<div class="item clx">
