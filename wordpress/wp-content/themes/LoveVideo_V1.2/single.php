...
?>
  ...
  <div id="bd">
	...
	var flashvars={
		f:'<?php bloginfo('template_url');?>/player/api/deng.php?v=<?php echo get_post_meta($post->ID,"video_url",true); ?>',
		s:2,
		c:0,
		p:1,
		b:1
...
while (have_posts()) : the_post();$thumbnail = wp_get_attachment_image_src(get_post_thumbnail_id(), 'large');?>
  ...
  <div id="ft">
    <p>本网站所涉及的内容均由内容提供商提供，本站不承担由于内容的合法性及健康性所引起的一切争议和法律责任。 <br>
      欢迎大家监督和举报,我们将在收到监督和举报后3个工作日内，将监督和举报转交给内容提供商。</p>
    <p> <a target="_blank" href="http://news.cctv.com/special/C20456/01/index.shtml">中国互联网视听节目服务自律公约</a> </p>
