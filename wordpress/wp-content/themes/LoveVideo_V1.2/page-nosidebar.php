...
<div id="single" class="clx">
	<div class="main">
		...
		<div class="widgets-data">
			...
			?>
			<ul class="clx">
				<li class="widgets-views"><a><?php if(function_exists('the_views')){$views = str_replace("views", "", the_views(0));?><span class="post-views post-span"><?php _e("Views", "LoveVideo");?></span><small><?php echo $views;?></small><?php }?></a></li>
				<li class="widgets-comments"><a href="#comments"><span class="post-comments">评论</span><small><?php echo $post->comment_count;?></small></a></li>
				<li class="widgets-likes"><?php if(function_exists('mflikes')) mflikes('button2');  ?></li>
				<?php if($linkOn){?>
	...
	<div class="post <?php echo get_post_format();?>">
		<div class="main-header">
			<center><h2 class="main-title"><?php the_title();?></h2></center>
			<div class="main-meta clx">			
				<div class="main-share">
					<span class="share-title"><?php _e('Share to&#58;', "LoveVideo");?></span>
...
<?php the_content(); ?> 		
		...
		<div class="main-navi clx">
			...
			<div class="pages-prev"><div class="inner"><?php if (get_next_post()) { next_post_link('%link'); }?></div></div>
		</div>
			<?php endwhile;endif; ?>
			<div class="articles">
...
<div id="footer">
  <div class="bd clx">
    <?php $options = get_option('mfthemes_options');
			if( $options['footer']){?>
    <?php echo $options['footer'];?> Theme By <a href="http://www.dz9.net/" title="多姿-关注互联网">多姿</a>
    <?php }else{?>
    <p>&copy; <?php echo date("Y");?> <a href="<?php bloginfo('url'); ?>" title="<?php bloginfo('name'); ?>">
      <?php bloginfo('name'); ?>
      </a> All Rights Reserved! </p>
    <p>Powered By WordPress, Theme By <a href="http://www.dz9.net/" title="mufeng">多姿</a></p>
    <?php }?>
	<?php $options = get_option('mfthemes_options');
	if( $options['analysis']){?>
