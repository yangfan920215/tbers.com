  ...
  <div class="col-sye p-cols">
    <div class="p-col1">
      <div class="p-col1-1">
        <div class="bx-syc">
          <div class="hd">
            <h2 class="h"> 关键字<strong>&#34;<?php echo $_GET['s'];?>&#34;</strong>的搜索结果 <span class="span">
          ...
          <div class="bd">
            <div class="filter">
              <ul class="tab-sya">
                <li class="tab-sya-item select"> <a href="javascript:void(0);" class="tab-link">搜索结果<span class="denote">▼</span></a> </li>
              </ul>
            </div>
            <div class="content">
              <ul class="p-list-syd">
              ...
              <?php if(!have_posts()):?>
              <p class="pl">抱歉，没有找到<strong class="orange">&#34;<?php echo $_GET['s'];?>&#34;</strong>的相关视频。</p>
              <p class="pl">建议您：缩短关键词并放宽筛选条件。</p>
              <p class="line-gra1216"></p>
              <h3> 大家都在看 </h3>
              <ul class="p-list-syd">
                <?php $rand_post = get_posts('numberposts=10&orderby=rand');  foreach( $rand_post as $post ) : ?>
                <li class="p-item"> <a href="<?php the_permalink(); ?>" class="thumb-outer thumb-outer-sya" target="_blank"> <img width="148" height="216" alt="<?php the_title();?>" src="<?php bloginfo('template_directory'); ?>/timthumb.php?src=<?php echo get_post_meta($post->ID,"video_poster",true); ?>&w=148&h=216" />
                  <div class="mask"> <span class="status right"> <?php echo get_post_meta($post->ID,"video_time",true); ?> </span> <span class="bg"></span> </div>
                  <span class="ico-play-64"></span>
                  <div class="mask-sya"></div>
